...
public class VodServiceImpl implements VodService {
    ...
    public String uploadVideoAly(MultipartFile file) {
        ...
        try {
            ...
            System.out.println(ConstantVodUtils.ACCESS_KEY_ID+"----ConstantVodUtils.ACCESS_KEY_ID");
...
//                System.out.println(file.getOriginalFilename()+"包含会");
                videoId = response.getVideoId();
            }
            return videoId;
        }catch(Exception e) {
